    ...
    <form className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
           ...
           <div className="flex gap-3">
            <input onChange={onChangeHandler} name='firstName' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='First Name' type="text" />
           ...
           <div className="flex gap-3">
            <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Postal Code' type="number" />
            <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Country' type="text" />
           </div>
           <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='CellPhone' type="number" />
      </div>
      {/* Right Side */}
      <div className="mt-8">
